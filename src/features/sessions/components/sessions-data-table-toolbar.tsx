...
export function SessionsDataTableToolbar<TData>({
  ...
  const disabled =
    activeOtherSessionCount === 0 || isRevokeOtherSessionsPending;
  const hasFilters = Boolean(
    search || status || deviceType || fromDate || toDate,
  );
          ...
          <AlertDialog>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  This will sign out {activeOtherSessionCount} other active
                  session
                  {activeOtherSessionCount === 1 ? "" : "s"}. Your current
